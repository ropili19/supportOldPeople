package com.rosario.authservice.config.mongodb;

import com.rosario.authservice.entities.MongoAccessToken;
import com.rosario.authservice.entities.MongoRefreshToken;
